public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: the index is set in 1 instead of 0 to get the value
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The keyword is insert instead of add and it only need to add the value not with the index like was before

...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Person with 1 turn remaining is bot handled correctly
    ...
    // Defect(s) Found: An error occur when the new player is added
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It is not running as expected when the person have 0 turns
    ...
    // Defect(s) Found: When is negative the person is not re-endqueued
